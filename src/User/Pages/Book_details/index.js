                    ...
                    <div className="card card-signup">
                        ...
                        <div className="input-group">
                                ...
                                <div className="input-group">
                                    ...
                                    <input type="text" className="form-control" onKeyUp={(e)=>dispatch(booking({...bookvalue,city:e.target.value}))} placeholder="city" />
                                </div>
                                <div className="input-group">
                                    <div className="input-group-prepend">
                                        <span className="input-group-text"><i className="now-ui-icons users_circle-08"></i></span>
                                    </div>
                                    <input type="text" className="form-control" onKeyUp={(e)=>dispatch(booking({...bookvalue,area:e.target.value}))} placeholder="Area" />
                                </div>
